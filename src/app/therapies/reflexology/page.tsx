...
const reflexology = () => {
  ...
  useEffect(() => {
    const fetchSellers = async () => {
      try {
        // Passo 1: Buscar o therapy_id de "reflexology"
        ...
        if (therapyError || !therapyData) {
          console.error("Error fetching reflexology therapy ID:", therapyError);
          console.log("Therapy data:", therapyData);
          return;
        }

        const reflexologyTherapyId = therapyData.id;
        console.log("reflexology therapy ID:", reflexologyTherapyId);

        // Passo 2: Buscar terapeutas associados a "reflexology" via seller_therapies
        const { data: sellerTherapiesData, error: sellerTherapiesError } = await supabase
          .from("seller_therapies")
          .select("seller_id")
          .eq("therapy_id", reflexologyTherapyId);
        ...
        console.log("Seller IDs with reflexology:", sellerIds);
        ...
        const sellersWithSpecialties = sellersData.map((seller) => ({
          ...seller,
          specialties: ["reflexology"], // Como já filtramos por reflexology, adicionamos diretamente
        }));
  ...
  const workshops = [
    {
      title: "reflexology Level I Certification",
      description: "Learn the basics of reflexology energy healing in this immersive workshop.",
      date: "March 15, 2025",
      location: "Zurich",
      price: "250 CHF",
    },
    {
      title: "Advanced reflexology Techniques",
    ...
    {
      title: "reflexology Meditation Retreat",
      description: "A weekend retreat combining reflexology and mindfulness practices.",
      date: "May 20-22, 2025",
      location: "Lausanne",
      price: "500 CHF",
    },
    ...
    <div className="min-h-screen bg-[#F8F5F1]">
      ...
      <section className="relative bg-gradient-to-br from-[#7C9A92] to-[#4A6670] text-white py-32 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h1 className="text-5xl md:text-7xl font-bold mb-6">reflexology Healing</h1>
          <p className="text-xl md:text-2xl text-[#E8DED1] max-w-3xl mx-auto mb-10">
            Experience the gentle power of reflexology – a practice that restores balance and promotes inner peace.
          </p>
      ...
      {/* About reflexology Section */}
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row gap-12 items-center">
          <div className="md:w-1/2">
            <h2 className="text-3xl font-bold text-[#4A6670] mb-4">What is reflexology?</h2>
            <p className="text-[#7C9A92] text-lg leading-relaxed">
              reflexology is a holistic practice that combines physical postures, breath control, and meditation to promote physical and emotional well-being. Whether you seek calm, clarity, or strength, reflexology offers a gentle path to balance and self-discovery.
            </p>
          </div>
          <div className="md:w-1/2">
            <Image
              src="https://images.unsplash.com/photo-1600585154340-be6161a56a0c?auto=format&fit=crop&q=80"
              alt="reflexology Practice"
      ...
      {/* Benefits of reflexology Section */}
      <section className="py-16 bg-[#F8F5F1]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-bold text-[#4A6670] mb-10 text-center">Benefits of reflexology</h2>
      ...
      <section className="py-16 bg-[#F8F5F1]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-bold text-[#4A6670] mb-8 text-center">Meet Our reflexology Practitioners</h2>
          {filteredSellers.length > 0 ? (
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {filteredSellers.map((seller) => (
                <UserCard
                  ...
                  title={seller.title || "reflexology Practitioner"}
                  ...
                  specialties={seller.specialties || ["reflexology"]}
            ...
            <div className="text-center">
              <p className="text-[#7C9A92] text-lg mb-4">No reflexology practitioners found matching your search.</p>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-bold text-[#4A6670] mb-10 text-center">reflexology Workshops & Courses</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-bold text-[#4A6670] mb-10 text-center">What People Say About reflexology</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              { content: "reflexology helped me find peace after years of stress. Truly transformative!", author: "Anna S., Zurich" },
      ...
      <section className="py-16 bg-gradient-to-br from-[#7C9A92] to-[#4A6670] text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl font-bold mb-4">Ready to Begin Your reflexology Journey?</h2>
